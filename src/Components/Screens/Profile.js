    ...
    <>
      ...
      <SignOut />
          <Card style={styles.profileContainer}>
            ...
            <Text category="h1" status="info">John Doe</Text>
            <Divider />
            <Text category="s1" style={styles.content}>No Shows: 0</Text>
          </Card>
          <Card style={styles.contentContainer}>
            <Text category="h5" >Favourite Games</Text>
            <Divider />
            <Text category="s1" style={styles.content}>No Favourite Games</Text>
          </Card>
          <Card style={styles.contentContainer}>
            <Text category="h5" >Owned Games</Text>
            <Divider />
            <Text category="s1" style={styles.content}>No Owned Games</Text>
          </Card>
          <Card style={styles.contentContainer}>
            <Text category="h5" >Joined Events</Text>
            <Divider />
            <Text category="s1" style={styles.content}>No Events Joined</Text>
          </Card>
      </View>
    </>
  );
